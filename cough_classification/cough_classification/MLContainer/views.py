...
# Check if a GPU is available for Linux machines (CUDA)
if torch.cuda.is_available():
    device = torch.device('cuda')
    print("cuda")
# Check if a GPU is available for macOS machines (Apple Silicon)
...
# Debugging: Check the type and content of the checkpoint
print(type(checkpoint))
if isinstance(checkpoint, dict):
    print("Keys in checkpoint:", checkpoint.keys())
else:
    print("Checkpoint is not a dictionary. Check how the model was saved.")
...
def ML_View(request):
    if request.method == 'POST':
        print("Received POST request")  # ✅ Ensure this prints
